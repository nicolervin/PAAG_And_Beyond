...
The implemented PFMEA editor follows the 19-column body structure of the project-owner-provided `FRM-GEA-QYS-033 PFMEA Template.xlsx`. A read-only Legacy Classification evidence column appears beside Classification when applicable and does not alter the workbook field mapping:
