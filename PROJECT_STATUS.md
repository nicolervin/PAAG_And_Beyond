...
- The committed `unittest` suite currently passes 32 tests covering planning-scenario behavior, scope selectors, shared direct-entry sorting and deletion-target interpretation, decimal Fishbone quantity migration and export, Assemblies catalog isolation/mini-BOM/rule/re-pointing/deletion behavior, and Pin Map data derivation.
